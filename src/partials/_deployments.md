...
:::info
This filter uses a raw JSON file to cover all contracts across all chains. While this is the best approach to provide comprehensive coverage, some contracts may be outdated or incorrect.
:::
