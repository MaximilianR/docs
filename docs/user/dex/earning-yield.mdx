...
<figure style={{ textAlign: 'center' }}>
  <ThemedImage
    alt="Pools Overview"
    sources={{
      light: require('@site/static/img/ui/dex/pool-rewards-overview-light.png').default,
      dark: require('@site/static/img/ui/dex/pool-rewards-overview-light.png').default,
    }}
    style={{
      maxWidth: '800px',
      width: '100%'
...
<figure style={{ textAlign: 'center' }}>
  <ThemedImage
    ...
    sources={{
      light: require('@site/static/img/user/dex/depositing-rewards.png').default,
      dark: require('@site/static/img/user/dex/depositing-rewards.png').default,
    }}
    style={{
      maxWidth: '800px',
      width: '100%'
...
<figure style={{ textAlign: 'center' }}>
  <ThemedImage
    ...
    sources={{
      light: require('@site/static/img/user/dex/staking-rewards.png').default,
      dark: require('@site/static/img/user/dex/staking-rewards.png').default,
    }}
    style={{
      maxWidth: '800px',
      width: '100%'
