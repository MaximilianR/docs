...
<figure style={{ textAlign: 'center' }}>
  <ThemedImage
    ...
    sources={{
      light: require('@site/static/img/user/dex/swap-light.png').default,
      dark: require('@site/static/img/user/dex/swap-light.png').default,
    }}
    style={{
      maxWidth: '600px',
      width: '100%'
...
The assets in these pools are supplied by other users, called **Liquidity Providers** (or LPs). Anyone can become an LP by depositing their assets into a pool.  When the assets deposited to a pool increases, swappers get better prices, which usually means more swaps.
...
<figure style={{ textAlign: 'center' }}>
  <ThemedImage
    ...
    sources={{
      light: require('@site/static/img/user/dex/basepools-metapools.png').default,
      dark: require('@site/static/img/user/dex/basepools-metapools.png').default,
    }}
    style={{
      maxWidth: '600px',
      width: '100%'
