---
id: dao-on-l2
title: Corss-Chain DAO Operations
sidebar_label: DAO & Voting
---
...
To participate in governance, users need [veCRV tokens](../curve-tokens/vecrv.mdx) on Ethereum mainnet. For detailed information about the DAO and voting processes, see the [Governance Overview](../dao/overview.md) or explore the guides below:
