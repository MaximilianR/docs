...
New CRV is minted weekly and distributed to Liquidity Providers (LPs). The issuance rate decreases over time, reducing by 16% once per year. A portion of the initial supply (1.3B) was distributed with vesting schedules that have now fully unlocked as of August 2024. The rest (1.7B) is emitted gradually over the next ~200 years.
