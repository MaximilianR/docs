...
The Community allocation represents a dedicated supply that is emitted over time as rewards for liquidity providers. Allocations for the Core Team, Investors, Employees and Early users have all fully unlocked.
