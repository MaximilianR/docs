...
<ThemedImage
    ...
    sources={{
        light: require('@site/static/img/user/llamalend/guides/open-close/connect_light.png').default,
        dark: require('@site/static/img/user/llamalend/guides/open-close/connect_dark.png').default,
    }}
...
<ThemedImage
    alt="Mint and Lend Markets"
    sources={{
        light: require('@site/static/img/user/llamalend/guides/open-close/markets_light.png').default,
        dark: require('@site/static/img/user/llamalend/guides/open-close/markets_dark.png').default,
    }}
    style={{ width: '800px', display: 'block', margin: '0 auto' }}
/>
</figure>
...
<ThemedImage
    alt="Mint and Lend Markets"
    sources={{
        light: require('@site/static/img/user/llamalend/guides/open-close/open_light.png').default,
        dark: require('@site/static/img/user/llamalend/guides/open-close/open_dark.png').default,
    }}
...
<ThemedImage
    alt="Mint and Lend Markets"
    sources={{
        light: require('@site/static/img/user/llamalend/guides/open-close/liq_range_light.png').default,
        dark: require('@site/static/img/user/llamalend/guides/open-close/liq_range_dark.png').default,
    }}
...
<ThemedImage
    alt="Mint and Lend Markets"
    sources={{
        light: require('@site/static/img/user/llamalend/guides/open-close/approve_light.png').default,
        dark: require('@site/static/img/user/llamalend/guides/open-close/approve_dark.png').default,
    }}
...
<ThemedImage
    alt="Mint and Lend Markets"
    sources={{
        light: require('@site/static/img/user/llamalend/guides/open-close/create_light.png').default,
        dark: require('@site/static/img/user/llamalend/guides/open-close/create_dark.png').default,
    }}
    style={{ width: '350px', display: 'block', margin: '0 auto' }}
/>
</figure>
...
<ThemedImage
    alt="Mint and Lend Markets"
    sources={{
        light: require('@site/static/img/user/llamalend/guides/open-close/position_overview_light.png').default,
        dark: require('@site/static/img/user/llamalend/guides/open-close/position_overview_dark.png').default,
    }}
    style={{ width: '700px', display: 'block', margin: '0 auto' }}
/>
</figure>
...
<ThemedImage
    alt="Mint and Lend Markets"
    sources={{
        light: require('@site/static/img/user/llamalend/guides/open-close/monitor_bot.png').default,
        dark: require('@site/static/img/user/llamalend/guides/open-close/monitor_bot.png').default,
    }}
...
<figure>
  <img 
    src="../../../static/images/crvusd/guides/open-close/close_light.png" 
    style={{ width: "400px" }} 
    className="only-light" 
    alt="Close Loan Light Theme" 
  />
  <img 
    src="../../../static/images/crvusd/guides/open-close/close_dark.png" 
    style={{ width: "400px" }} 
    className="only-dark" 
    alt="Close Loan Dark Theme" 
  />
</figure>