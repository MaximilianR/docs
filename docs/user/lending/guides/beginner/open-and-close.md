...
<figure>
  <img 
    src="../../../static/images/crvusd/guides/open-close/connect_light.png" 
    style={{ width: "500px" }} 
    className="only-light" 
    alt="Connect Wallet Light Theme" 
  />
  <img 
    src="../../../static/images/crvusd/guides/open-close/connect_dark.png" 
    style={{ width: "500px" }} 
    className="only-dark" 
    alt="Connect Wallet Dark Theme" 
  />
</figure>
...
<figure>
  <img 
    src="../../../static/images/crvusd/guides/open-close/markets_light.png" 
    style={{ width: "800px" }} 
    className="only-light" 
    alt="Select Market Light Theme" 
  />
  <img 
    src="../../../static/images/crvusd/guides/open-close/markets_dark.png" 
    style={{ width: "800px" }} 
    className="only-dark" 
    alt="Select Market Dark Theme" 
  />
</figure>
...
<figure>
  <img 
    src="../../../static/images/crvusd/guides/open-close/open_light.png" 
    style={{ width: "400px" }} 
    className="only-light" 
    alt="Specify Parameters Light Theme" 
  />
  <img 
    src="../../../static/images/crvusd/guides/open-close/open_dark.png" 
    style={{ width: "400px" }} 
    className="only-dark" 
    alt="Specify Parameters Dark Theme" 
  />
</figure>
...
<figure>
  <img 
    src="../../../static/images/crvusd/guides/open-close/liq_range_light.png" 
    style={{ width: "700px" }} 
    className="only-light" 
    alt="Liquidation Range Light Theme" 
  />
  <img 
    src="../../../static/images/crvusd/guides/open-close/liq_range_dark.png" 
    style={{ width: "700px" }} 
    className="only-dark" 
    alt="Liquidation Range Dark Theme" 
  />
</figure>
...
<figure>
  <img 
    src="../../../static/images/crvusd/guides/open-close/approve_light.png" 
    style={{ width: "350px" }} 
    className="only-light" 
    alt="Approve Light Theme" 
  />
  <img 
    src="../../../static/images/crvusd/guides/open-close/approve_dark.png" 
    style={{ width: "350px" }} 
    className="only-dark" 
    alt="Approve Dark Theme" 
  />
</figure>
...
<figure>
  <img 
    src="../../../static/images/crvusd/guides/open-close/create_light.png" 
    style={{ width: "350px" }} 
    className="only-light" 
    alt="Create Loan Light Theme" 
  />
  <img 
    src="../../../static/images/crvusd/guides/open-close/create_dark.png" 
    style={{ width: "350px" }} 
    className="only-dark" 
    alt="Create Loan Dark Theme" 
  />
</figure>
...
<figure>
  <img 
    src="../../../static/images/crvusd/guides/open-close/position_overview_light.png" 
    style={{ width: "700px" }} 
    className="only-light" 
    alt="Position Overview Light Theme" 
  />
  <img 
    src="../../../static/images/crvusd/guides/open-close/position_overview_dark.png" 
    style={{ width: "700px" }} 
    className="only-dark" 
    alt="Position Overview Dark Theme" 
  />
</figure>
...
<figure>
  <img 
    src="../../../static/images/crvusd/new/monitor_bot.png" 
    style={{ width: "400px" }} 
    alt="Monitor Bot" 
  />
</figure>
