...
!!!warning "Differences in Leverage Support"
    ...
    <figure>
        <img 
            src="../../../static/images/crvusd/guides/leverage/leverage_tab_light.png" 
            style={{ width: "250px" }} 
            className="only-light" 
            alt="Leverage Tab Light Theme" 
        />
        <img 
            src="../../../static/images/crvusd/guides/leverage/leverage_tab_dark.png" 
            style={{ width: "250px" }} 
            className="only-dark" 
            alt="Leverage Tab Dark Theme" 
        />
    </figure>
...
<figure>
    <img 
        src="../../../static/images/crvusd/guides/leverage/borrow_light.png" 
        style={{ width: "350px" }} 
        className="only-light" 
        alt="Leverage Borrow Light Theme" 
    />
    <img 
        src="../../../static/images/crvusd/guides/leverage/borrow_dark.png" 
        style={{ width: "350px" }} 
        className="only-dark" 
        alt="Leverage Borrow Dark Theme" 
    />
</figure>
...
<figure>
    <img 
        src="../../../static/images/crvusd/guides/leverage/borrow_overview_light.png" 
        style={{ width: "300px" }} 
        className="only-light" 
        alt="Leverage Borrow Overview Light Theme" 
    />
    <img 
        src="../../../static/images/crvusd/guides/leverage/borrow_overview_dark.png" 
        style={{ width: "300px" }} 
        className="only-dark" 
        alt="Leverage Borrow Overview Dark Theme" 
    />
</figure>
...
<figure>
    <img 
        src="../../../static/images/crvusd/guides/leverage/repay_light.png" 
        style={{ width: "350px" }} 
        className="only-light" 
        alt="Leverage Repay Light Theme" 
    />
    <img 
        src="../../../static/images/crvusd/guides/leverage/repay_dark.png" 
        style={{ width: "350px" }} 
        className="only-dark" 
        alt="Leverage Repay Dark Theme" 
    />
</figure>
...
<figure>
    <img 
        src="../../../static/images/crvusd/guides/leverage/repay_overview_light.png" 
        style={{ width: "300px" }} 
        className="only-light" 
        alt="Leverage Repay Overview Light Theme" 
    />
    <img 
        src="../../../static/images/crvusd/guides/leverage/repay_overview_dark.png" 
        style={{ width: "300px" }} 
        className="only-dark" 
        alt="Leverage Repay Overview Dark Theme" 
    />
</figure>
