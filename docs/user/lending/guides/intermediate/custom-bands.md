...
<figure>
  <img 
    src="../../../static/images/crvusd/guides/bands/borrow_light.png" 
    style={{ width: "350px" }} 
    className="only-light" 
    alt="Borrow Interface Light" 
  />
  <img 
    src="../../../static/images/crvusd/guides/bands/borrow_dark.png" 
    style={{ width: "350px" }} 
    className="only-dark" 
    alt="Borrow Interface Dark" 
  />
</figure>
