...
<figure>
  <ThemedImage
    alt="Standard ERC20"
    sources={{
      light: require('@site/static/img/resource/pool_creation/ss_erc20_light.png').default,
      dark: require('@site/static/img/resource/pool_creation/ss_erc20_dark.png').default,
    }}
    style={{ 
      width: "600px",
      display: "block",
...
<figure>
  <ThemedImage
    alt="Standard ERC20"
    sources={{
      light: require('@site/static/img/resource/pool_creation/ss_oracle_dark.png').default,
      dark: require('@site/static/img/resource/pool_creation/ss_oracle_light.png').default,
    }}
    style={{ 
      width: "600px",
      display: "block",
