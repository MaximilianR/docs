...
Getter method for the fee of the pool. This is the value set when initializing the contract and can be changed via [`set_new_fee`](../pools/admin-controls.md#set_new_fee).
