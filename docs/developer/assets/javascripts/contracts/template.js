// logic for fetching data from a contract
// requirements:
// - add contract address
// - add abi
// - update values function and element ids
// - modify results to match the data you want to fetch so it returns the output in a nice manner
...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    async function updateValues() {
        ...
        try {
            ...
            const elementIds = [
                'tokenLastBalanceOutput', 'lastTokenTimeOutput', 'canCheckpointTokenOutput',
                'timeCursorOutput', 'isKilledOutput', 'emergencyReturnOutput',
                'adminOutput', 'futureAdminOutput', 'startTimeOutput',
                'votingEscrowOutput', 'tokenOutput'
            ];
