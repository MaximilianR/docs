...
-   **Oracle from a single Curve pool**---
    ...
    [→ `CryptoFromPool`](./cryptofrompool.md)
...
-   **Oracle from multiple chained Curve pools**---
    ...
    [→ `CryptoFromPoolsRate`](./cryptofrompoolsrate.md)
