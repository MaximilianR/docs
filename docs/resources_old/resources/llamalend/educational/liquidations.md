...
<figure markdown="span">
    <img src="../../crvusd/images/education/liquidation/liq_range_light.png" alt="Liquidation Range" width="600" />
    <img src="../../crvusd/images/education/liquidation/liq_range_dark.png" alt="Liquidation Range" width="600" />
...
<img src="../images/crvusd/soft-liq.svg" className="centered" alt="Collateral Loss" />
<img src="../images/crvusd/soft-liq-dark.svg" className="centered" alt="Collateral Loss" />
...
<div id="ethCrvUsdChartContainer">
    <h2 style={{margin: "10px 0 20px", textAlign: "center"}}>Soft-liquidation Collateral Conversion</h2>
    <div style={{marginTop: "10px"}}>
        <label htmlFor="collateralInput">Collateral Amount (ETH):</label>
        <input type="number" id="collateralInput" className="price-input" defaultValue="10" min="0" step="0.1" />
    </div>
    <div style={{position: "relative", marginTop: "20px"}}>
        ...
        <div style={{display: "flex", justifyContent: "space-between", marginTop: "5px"}}>
            <input type="number" id="bottomRange" className="price-input" defaultValue="2311.92" />
            <span id="currentPrice" style={{fontWeight: "bold"}}></span>
            <input type="number" id="topRange" className="price-input" defaultValue="2556.35" />
        </div>
        <input type="range" id="ethCrvUsdSlider" style={{width: "100%"}} min="0" max="100" defaultValue="50" />
    </div>
    <canvas id="ethCrvUsdChart"></canvas>
    <div id="ethCrvUsdValues" style={{textAlign: "center", marginTop: "10px"}}></div>
</div>
