...
<figure>
  <img src="../images/crvusd/education/overview/light.png" alt="Image title" width="800" className="only-light" />
  <img src="../images/crvusd/education/overview/dark.png" alt="Image title" width="800" className="only-dark" />
