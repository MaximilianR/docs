...
<img src="../images/scrvusd/scrvusd_as_a_user_light.svg" className="centered" alt="scrvUSD as a user" />
<img src="../images/scrvusd/scrvusd_as_a_user_dark.svg" className="centered" alt="scrvUSD as a user" />
...
<img src="../images/scrvusd/scrvusd_fee_split_light.svg" className="centered" style={{width: "75%"}} alt="Revenue Distributor" />
<img src="../images/scrvusd/scrvusd_fee_split_dark.svg" className="centered" style={{width: "75%"}} alt="Revenue Distributor" />
...
:::note Example: How much crvUSD revenue will be allocated to scrvUSD?
...
<img src="../images/scrvusd/before_scrvusd_light.svg" className="centered" style={{width: "85%"}} alt="scrvUSD before State Diagram" />
<img src="../images/scrvusd/before_scrvusd_dark.svg" className="centered" style={{width: "85%"}} alt="scrvUSD before State Diagram" />
...
<img src="../images/scrvusd/after_scrvusd_light.svg" className="centered" style={{width: "90%"}} alt="scrvUSD after State Diagram" />
<img src="../images/scrvusd/after_scrvusd_dark.svg" className="centered" style={{width: "90%"}} alt="scrvUSD after State Diagram" />
...
:::note Example: yield calculation
