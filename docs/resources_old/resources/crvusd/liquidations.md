...
<figure>
  <img 
    src="../images/crvusd/education/liquidation/liq_range_light.png" 
    style={{ width: "600px" }} 
    className="only-light" 
    alt="Liquidation Range Light Theme" 
  />
  <img 
    src="../images/crvusd/education/liquidation/liq_range_dark.png" 
    style={{ width: "600px" }} 
    className="only-dark" 
...
:::tip How does it compare to other protocols?
