...
![UI Leverage](../images/ui/leverage.png)

How built-in leverage works:

![UI Leverage](../images/lending/leverage.svg)
...
![Leverage with a combination of assets](../images/lending/add_both_leverage.svg)
...
<Tabs>
  <TabItem value="light" label="Light Mode">
    <img src="../images/lending/leverage_simple.svg" alt="Leverage Looping" />
  </TabItem>
