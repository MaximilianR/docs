...
<Tabs>
  <TabItem value="light" label="Light Mode">
    <img src="../../../images/crvusd/guides/bands/borrow_light.png" alt="Borrow Interface" width="350" />
  </TabItem>
  <TabItem value="dark" label="Dark Mode">
    <img src="../../../images/crvusd/guides/bands/borrow_dark.png" alt="Borrow Interface" width="350" />
  </TabItem>
</Tabs>
...
```math
Maximum LTV = 100 - loan_discount - 100 × (N / (2 × A))
```
