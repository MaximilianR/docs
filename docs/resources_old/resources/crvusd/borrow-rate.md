...
<figure>
  <img 
    src="../images/crvusd/education/borrow-rate/light.png" 
    style={{ width: "600px" }} 
    className="only-light" 
    alt="Borrow Rate Light Theme" 
  />
  <img 
    src="../images/crvusd/education/borrow-rate/dark.png" 
    style={{ width: "600px" }} 
    className="only-dark" 
    alt="Borrow Rate Dark Theme" 
  />
</figure>
...
<figure>
  <img 
    src="../images/crvusd/education/borrow-rate/new_rate_light.png" 
    style={{ width: "350px" }} 
    className="only-light" 
    alt="New Rate Light Theme" 
  />
  <img 
    src="../images/crvusd/education/borrow-rate/new_rate_dark.png" 
    style={{ width: "350px" }} 
    className="only-dark" 
    alt="New Rate Dark Theme" 
  />
