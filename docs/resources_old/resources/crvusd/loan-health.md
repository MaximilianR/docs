...
<figure>
  <img src="../images/crvusd/education/health/monitor-bot.png" alt="" width="500" />
  <figcaption>
    Check out this article for more information on how to set up the Telegram Bot: 
    <a href="https://news.curve.fi/llamalend-telegram-bot/" target="_blank" rel="noopener noreferrer">
      https://news.curve.fi/llamalend-telegram-bot/
    </a>
  </figcaption>
</figure>