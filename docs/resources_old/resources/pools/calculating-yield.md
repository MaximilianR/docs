...
```math
\left( \frac{\text{virtual\_price}(t=0)}{\text{virtual\_price}(t=-1)} \right)^{365} - 1
```
...
<img src="../images/ui/virtual-price.webp" alt="Virtual Price" />
...
```math
tAPR = \frac{\text{crv\_price} \times \text{inflation\_rate} \times \text{relative\_weight} \times 12614400}{\text{working\_supply} \times \text{asset\_price} \times \text{virtual\_price}}
```
