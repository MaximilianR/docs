...
<div className="centered">
  <img src="../images/pools/stableswap.svg" alt="Stableswap" className="only-light" />
  <img src="../images/pools/stableswap-dark.svg" alt="Stableswap" className="only-dark" />
</div>
...
<div className="centered">
  <img src="../images/pools/cryptoswap.svg" alt="Cryptoswap" className="only-light" />
  <img src="../images/pools/cryptoswap-dark.svg" alt="Cryptoswap" className="only-dark" />
</div>
...
<div className="centered">
  <img src="../images/pools/rewards.svg" alt="Rewards" className="only-light" style={{ width: "500px" }} />
  <img src="../images/pools/rewards-dark.svg" alt="Rewards" className="only-dark" style={{ width: "500px" }} />
</div>
