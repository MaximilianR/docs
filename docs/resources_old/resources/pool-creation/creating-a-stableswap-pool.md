...
<figure>
  <img 
    src={require('@site/static/img/resource/pool_creation/ss_erc20_dark.png').default}
    className="only-dark"
    style={{ width: "400px" }}
    alt="Standard ERC20 Dark"
  />
  <img 
    src={require('@site/static/img/resource/pool_creation/ss_erc20_light.png').default}
    className="only-light"
    style={{ width: "400px" }}
    alt="Standard ERC20 Light"
  />
...
<figure>
  <img 
    src={require('@site/static/img/resource/pool_creation/ss_oracle_dark.png').default}
    className="only-dark"
    style={{ width: "400px" }}
    alt="Oracle Token Dark"
  />
  <img 
    src={require('@site/static/img/resource/pool_creation/ss_oracle_light.png').default}
    className="only-light"
    style={{ width: "400px" }}
    alt="Oracle Token Light"
  />
  <figcaption></figcaption>
</figure>
...
<figure>
  <img 
    src={require('@site/static/img/resource/pool_creation/ss_rebasing_dark.png').default}
    className="only-dark"
    style={{ width: "400px" }}
    alt="Rebasing Token Dark"
  />
  <img 
    src={require('@site/static/img/resource/pool_creation/ss_rebasing_light.png').default}
    className="only-light"
    style={{ width: "400px" }}
    alt="Rebasing Token Light"
  />
  <figcaption></figcaption>
</figure>
...
<figure>
  <img 
    src={require('@site/static/img/resource/pool_creation/ss_erc4626_dark.png').default}
    className="only-dark"
    style={{ width: "400px" }}
    alt="ERC4626 Token Dark"
  />
  <img 
    src={require('@site/static/img/resource/pool_creation/ss_erc4626_light.png').default}
    className="only-light"
    style={{ width: "400px" }}
    alt="ERC4626 Token Light"
  />
  <figcaption></figcaption>
</figure>
...
<figure>
  <img 
    src={require('@site/static/img/resource/pool_creation/ss_presets_dark.png').default}
    className="only-dark"
    style={{ width: "400px" }}
    alt="Presets Dark"
  />
  <img 
    src={require('@site/static/img/resource/pool_creation/ss_presets_light.png').default}
    className="only-light"
    style={{ width: "400px" }}
    alt="Presets Light"
  />
...
<figure>
  <img 
    src={require('@site/static/img/resource/pool_creation/ss_parameters_advanced_dark.png').default}
    className="only-dark"
    style={{ width: "400px" }}
    alt="Parameters Advanced Dark"
  />
  <img 
    src={require('@site/static/img/resource/pool_creation/ss_parameters_advanced_light.png').default}
    className="only-light"
    style={{ width: "400px" }}
    alt="Parameters Advanced Light"
  />
  <figcaption></figcaption>
</figure>
...
<figure>
  <img 
    src={require('@site/static/img/resource/pool_creation/ss_info_dark.png').default}
    className="only-dark"
    style={{ width: "400px" }}
    alt="Pool Info Dark"
  />
  <img 
    src={require('@site/static/img/resource/pool_creation/ss_info_light.png').default}
    className="only-light"
    style={{ width: "400px" }}
    alt="Pool Info Light"
  />
...
<figure>
  <img 
    src={require('@site/static/img/resource/pool_creation/ss_summary_dark.png').default}
    className="only-dark"
    style={{ width: "300px" }}
    alt="Pool Summary Dark"
  />
  <img 
    src={require('@site/static/img/resource/pool_creation/ss_summary_light.png').default}
    className="only-light"
    style={{ width: "300px" }}
    alt="Pool Summary Light"
  />
  <figcaption></figcaption>
</figure>
