...
To actually create an on-chain proposal, 2500 veCRV are required. <sup>1</sup>

<sup>1</sup> But there's nothing to worry about, my friend. If you don't have 2500 veCRV, there are plenty of helpful community members who will surely help you create one.

## Creating your vote

Visit the Curve DAO: [https://curve.fi/dao](https://curve.fi/dao), select your type of vote and submit it.

<img src="../../images/ui/crate-vote.webp" alt="Create Vote UI" />
...
<img src="../../images/ui/proposal_guidelines.webp" alt="Proposal Guidelines" />
