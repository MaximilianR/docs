...
<img src="../images/gov/voting-proposal-example-light.png" alt="Proposal Example" className="centered" />
<img src="../images/gov/voting-proposal-example-dark.png" alt="Proposal Example" className="centered" />
...
<img src="../images/gov/voting-power-light.png" alt="Proposal Voting Power Decay" className="centered" />
<img src="../images/gov/voting-power-dark.png" alt="Proposal Voting Power Decay" className="centered" />
