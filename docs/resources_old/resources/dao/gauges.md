...
<img src="../images/gov/gauge-relative-weight-light.png" alt="Gauge Relative Weights" className="centered" />
<img src="../images/gov/gauge-relative-weight-dark.png" alt="Gauge Relative Weights" className="centered" />
