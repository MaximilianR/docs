...
<div className="centered">
  <img src="../images/fee_collection/stableswap_fees.svg" alt="Stableswap Fees" className="only-light" />
  <img src="../images/fee_collection/stableswap_fees_dark.svg" alt="Stableswap Fees" className="only-dark" />
</div>
...
<div className="centered">
  <img src="../images/fee_collection/cryptoswap_fees.svg" alt="Cryptoswap Fees" className="only-light" />
  <img src="../images/fee_collection/cryptoswap_fees_dark.svg" alt="Cryptoswap Fees" className="only-dark" />
</div>
...
<div className="centered">
  <img src="../images/fee_collection/crvusd_fees.svg" alt="crvUSD Minting Market Fees" className="only-light" />
  <img src="../images/fee_collection/crvusd_fees_dark.svg" alt="crvUSD Minting Market Fees" className="only-dark" />
</div>
...
<div className="centered">
  <img src="../images/fee_collection/fee_collecting_phase.svg" alt="Fee Collection" className="only-light" />
  <img src="../images/fee_collection/fee_collecting_phase_dark.svg" alt="Fee Collection" className="only-dark" />
</div>
...
<div className="centered">
  <img src="../images/fee_collection/fee_exchanging_phase.svg" alt="Fee Exchanging" className="only-light" />
  <img src="../images/fee_collection/fee_exchanging_phase_dark.svg" alt="Fee Exchanging" className="only-dark" />
</div>
...
<div className="centered">
  <img src="../images/fee_collection/fee_splitter.svg" alt="Fee Splitter" className="only-light" />
  <img src="../images/fee_collection/fee_splitter_dark.svg" alt="Fee Splitter" className="only-dark" />
</div>
